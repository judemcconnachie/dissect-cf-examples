 ...
 */
public class RoundRobinJobScheduler implements JobLauncher, ConsumptionEvent {
	 ...
	 */
	public RoundRobinJobScheduler(final VirtualInfrastructure vi, final Progress pr) {
		this.vi = vi;
		this.progress = pr;
	}
